...
# Props 정의
상위 컴포넌트의 데이터를 하위 컴포넌트로 전달하는 데이터들을 Properties라고 합니다. 보통 Props를 전달한다고 이야기합니다. Vue.js에서 Props를 전달하는 방법은 아래 코드와 같습니다.
...
간결함을 장점으로 이야기하는 Svelte 코드는 역시 Vue.js로 작성된 코드보다 적은 양의 코드로 동일한 동작을 하는 코드를 작성할 수 있습니다.
