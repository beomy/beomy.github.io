...
function Se(e, t) {
  ...
  for (
    ...
    '__ob__' !== (n = o[a]) &&
      ((r = e[n]),
      (i = t[n]),
      y(e, n) ? r !== i && s(r) && s(i) && Se(r, i) : Ae(e, n, i));
  return e;
}
function Te(e, t, n) {
  return n
...
function bt(e, t) {
  ...
  return r && !t
    ...
    : (wt(
        (r = n[e] =
          this.$options.staticRenderFns[e].call(this._renderProxy, null, this)),
        '__static__' + e,
        !1,
      ),
      r);
...
!(function (e) {
  ...
  Object.defineProperty(e, 'config', t),
    (e.util = { warn: ae, extend: k, mergeOptions: De, defineReactive: xe }),
    (e.set = Ae),
    (e.delete = ke),
    (e.nextTick = Ye),
...
function bi(e) {
  if (e) {
    if ('object' == typeof e) {
      var t = {};
      return !1 !== e.css && k(t, $i(e.name || 'v')), k(t, e), t;
    }
...
wi &&
  (void 0 === window.ontransitionend &&
    ...
    ((Ai = 'WebkitTransition'), (ki = 'webkitTransitionEnd')),
...
function Mi(e, t) {
  ...
  return (
          ...
          : 0),
    {
      ...
      timeout: l,
      propCount: f,
      hasTransform: n === Ci && Li.test(r[Ai + 'Property']),
    }
  );
}
function Ii(e, t) {
...
(wn.config.mustUseProp = jn),
  ...
  k(wn.options.directives, Qi),
  k(wn.options.components, fo),
...
var yo,
  ...
  _o = function (e) {
    return (
      ((yo = yo || document.createElement('div')).innerHTML = e), yo.textContent
    );
  },
  bo = p(
...
var Ia = {
  ...
  Fa = function (e) {
    (this.options = e),
      ...
      (this.directives = k(k({}, Ia), e.directives));
...
var es,
  ...
  ns = ((es = function (e, t) {
    var n = la(e.trim(), t);
    console.log('[AFTER PARSE]', n),
      !1 !== t.optimize && (Aa(n, t), console.log('[AFTER OPTIMIZE]', n));
    var r = Pa(n, t);
    return (
      console.log('[AFTER GENERATE]', r),
  ...
  function (e) {
    function t(t, n) {
      ...
      if (n)
        ...
        n.directives &&
          (r.directives = k(Object.create(e.directives || null), n.directives)),
        n))
