  ...
  if (o(r.options.functional))
    return (function (e, o, r, s, i) {
      ...
      if (Array.isArray(f)) {
        ...
        for (let n = 0; n < t.length; n++) e[n] = ke(t[n], r, u.parent, a);
        return e;
      }
    })(r, p, i, a, c);
  const h = i.on;
...
!(function (t) {
  ...
  Object.defineProperty(t, 'config', e),
    (t.util = { warn: it, extend: A, mergeOptions: jt, defineReactive: Ct }),
    (t.set = xt),
    (t.delete = kt),
    (t.nextTick = qt),
...
function ur(t, o) {
  ...
  const p = (function (t, e) {
    ...
    (o = nr(t.data)) && A(n, o);
    let r = t;
    for (; (r = r.parent); ) r.data && (o = nr(r.data)) && A(n, o);
    return n;
  })(o, !0);
  ...
  t.data.show ||
    ...
    F &&
      ...
      kr(() => {
        Or(r, S),
          R.cancelled ||
            (Ar(r, E), P || (Mr(I) ? setTimeout(R, I) : Sr(r, c, R)));
      })),
    ...
    w.cancelled ||
      ...
      $ &&
        ...
        kr(() => {
          Or(r, l),
            w.cancelled ||
              (Ar(r, u), _ || (Mr(b) ? setTimeout(w, b) : Sr(r, c, w)));
        })),
      h && h(r, w),
      $ || _ || w());
  }
          ...
          (function (t, o, r, s, i) {
            ...
            for (; p <= m && h <= v; )
              e(y)
                ...
                : Yn(y, w)
                ? (x(y, w, s, r, v),
                  k && l.insertBefore(t, y.elm, l.nextSibling(g.elm)),
                  (y = o[++p]),
                  (w = r[--v]))
                : Yn(g, _)
                ? (x(g, _, s, r, h),
                  k && l.insertBefore(t, g.elm, y.elm),
                  (g = o[--m]),
                  (_ = r[++h]))
                : (e(a) && (a = Qn(o, p, m)),
                  e((c = n(_.key) ? a[_.key] : C(_, o, p, m)))
                    ...
                    ? (x(u, _, s, r, h),
                      (o[c] = void 0),
                      k && l.insertBefore(t, u.elm, y.elm))
                    : f(_, s, t, y.elm, !1, r, h),
                  (_ = r[++h]));
            p > m
...
const ns = A({ tag: String, moveClass: String }, Zr);
function os(t) {
...
(yn.config.mustUseProp = An),
  ...
  A(yn.options.directives, Wr),
  A(yn.options.components, is),
...
function si(t, e) {
  ...
  !(function (t) {
    ...
    (function (t) {
      let e;
      'template' === t.tag
        ? ((e = Ao(t, 'scope')), (t.slotScope = e || Ao(t, 'slot-scope')))
        : (e = Ao(t, 'slot-scope')) && (t.slotScope = e);
      const n = ko(t, 'slot');
      n &&
    ...
    'slot' === (n = t).tag && (n.slotName = ko(n, 'name')),
    (function (t) {
      let e;
  ...
  fs,
  {
    preTransformNode: function (t, e) {
      if ('input' === t.tag) {
        ...
        let o;
        if (
          ((n[':type'] || n['v-bind:type']) && (o = ko(t, 'type')),
          n.type || o || !n['v-bind'] || (o = `(${n['v-bind']}).type`),
          o)
        ) {
          const n = Ao(t, 'v-if', !0),
            r = n ? `&&(${n})` : '',
            s = null != Ao(t, 'v-else', !0),
            i = Ao(t, 'v-else-if', !0),
            a = pi(t);
          ii(a),
            bo(a, 'type', 'checkbox'),
...
class Ni {
  constructor(t) {
    (this.options = t),
      ...
      (this.directives = A(A({}, Ei), t.directives));
